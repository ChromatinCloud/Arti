#!/usr/bin/env python3
"""
Standalone processor for ClinVar Pathogenic/Likely Pathogenic (PLP) variants through OncoKB API
"""
...
ONCOKB_API_TOKEN = os.getenv("ONCOKB_API_TOKEN", "demo")
HEADERS = {
...
def process_file(file_path: str, batch_size: int = 500):
...
def main():
    ...
    # Process the file
    process_file(str(plp_file), batch_size=batch_size)
